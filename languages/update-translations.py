...
NEW_STRINGS_FORMAL_SS = {
    ...
    "Continue": "Weiter",
    "Which modules do you need?": "Welche Module brauchen Sie?",
    "Start with a sample menu?": "Mit einer Beispielkarte starten?",
    "Create sample menu": "Beispielkarte anlegen",
    "Finish setup": "Einrichtung abschliessen",
    "Run the setup assistant": "Einrichtungsassistenten starten",
    "Setup steps": "Einrichtungsschritte",
    "Creating sample menu…": "Beispielkarte wird angelegt …",
    "Sample menu created.": "Beispielkarte wurde angelegt.",
    "Something went wrong. Please try again.": "Etwas ist schiefgelaufen. Bitte erneut versuchen.",
    "Saving…": "Wird gespeichert …",
    "WooCommerce is active": "WooCommerce ist aktiv",
    "PHP %s or newer": "PHP %s oder neuer",
    "Currently running PHP %s.": "Aktuell läuft PHP %s.",
    "A currency is configured": "Eine Währung ist konfiguriert",
    "At least one payment method is enabled": "Mindestens eine Zahlungsart ist aktiv",
    "Scheduled tasks are running": "Geplante Aufgaben laufen",
    "WooCommerce is required.": "WooCommerce wird benötigt.",
    ...
    "Side salad": "Beilagensalat",
    "Extra spicy": "Extra scharf",
    "Classic Burger": "Classic Burger",
    "Veggie Bowl": "Veggie Bowl",
    "Pasta of the Day": "Pasta des Tages",
    "Soup of the Day": "Suppe des Tages",
    "Fries": "Pommes",
    "Green Salad": "Grüner Salat",
    "Mineral Water 5dl": "Mineralwasser 5dl",
    "Coffee": "Kaffee",
    # Order Bumps (F46)
