...
<div class="wrap">
		...
		<table class="widefat striped">
			<tbody>
				...
				<tr>
					...
					<td><?php echo defined( 'LB_VERSION' ) ? esc_html( LB_VERSION ) : '-'; ?></td>
				</tr>
				<tr>
	...
	<div class="lb-debug-section" style="margin-top: 30px;">
		...
		<table class="widefat striped">
			<tbody>
				...
				<tr>
					...
					<td><?php echo esc_html( get_option( 'lb_preparation_time', 30 ) . ' ' . __( 'Minuten', 'libre-bite' ) ); ?></td>
				</tr>
				<tr>
					<th><?php esc_html_e( 'Zeitslot-Intervall', 'libre-bite' ); ?></th>
					<td><?php echo esc_html( get_option( 'lb_timeslot_interval', 15 ) . ' ' . __( 'Minuten', 'libre-bite' ) ); ?></td>
				</tr>
				<tr>
					<th><?php esc_html_e( 'Rundung aktiviert', 'libre-bite' ); ?></th>
					<td><?php echo get_option( 'lb_enable_rounding', false ) ? esc_html__( 'Ja', 'libre-bite' ) : esc_html__( 'Nein', 'libre-bite' ); ?></td>
				</tr>
				<tr>
					...
					<td>
						<?php
						echo esc_html(
							get_option( 'lb_tip_percentage_1', 5 ) . '%, ' .
							get_option( 'lb_tip_percentage_2', 10 ) . '%, ' .
							get_option( 'lb_tip_percentage_3', 15 ) . '%'
						);
						?>
					</td>
				</tr>
				...
				<tr>
					...
					<td><?php echo get_option( 'lb_delete_data_on_uninstall', false ) ? '<span style="color: red;">' . esc_html__( 'Ja', 'libre-bite' ) . '</span>' : esc_html__( 'Nein', 'libre-bite' ); ?></td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<div class="lb-debug-section" style="margin-top: 30px;">
		...
		<table class="widefat striped">
			<tbody>
				<?php
				$cron_hooks = array(
					'lb_check_pickup_reminders' => __( 'Pickup-Erinnerungen prüfen', 'libre-bite' ),
					'lb_check_preorders'        => __( 'Vorbestellungen prüfen', 'libre-bite' ),
				);
