...
<div class="lbite-help-section">
	...
	<div class="lbite-help-article">
		...
		<p><?php esc_html_e( 'Der Checkout-Tab enthält zwei Bereiche: die Feldkonfiguration und weitere Checkout-Optionen.', 'libre-bite' ); ?></p>
		<table class="widefat">
			<thead><tr><th><?php esc_html_e( 'Einstellung', 'libre-bite' ); ?></th><th><?php esc_html_e( 'Was es bewirkt', 'libre-bite' ); ?></th></tr></thead>
			<tbody>
				<tr>
					<td><strong><?php esc_html_e( 'Checkout-Felder', 'libre-bite' ); ?></strong></td>
					<td><?php esc_html_e( 'Wähle, welche Felder der Kunde beim Bestellen ausfüllen muss (z.B. Vorname, E-Mail, Telefon). Für Take-Away reicht oft nur der Vorname.', 'libre-bite' ); ?></td>
				</tr>
				...
				<tr>
					...
					<td><?php esc_html_e( '"Standard" zeigt den normalen WooCommerce-Checkout. "Optimiert" (Pro) reduziert ihn auf das Wesentliche: nur Name und Beleg-Option – ideal für Take-Away ohne Lieferung.', 'libre-bite' ); ?></td>
				</tr>
				<?php endif; ?>
			</tbody>
		</table>
