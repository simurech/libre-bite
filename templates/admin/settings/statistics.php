 ...
 * Tab: Statistik
 *
 * Zeigt Umsatz und Bestellanzahl pro Standort, filterbar nach Zeitraum.
 * Implementierung via wc_get_orders() + optionalem Chart.js.
 *
 * @package LibreBite
 */
...
<div style="display: flex; gap: 16px; margin-bottom: 24px; flex-wrap: wrap;">
	<div style="background:#fff; border:1px solid #dcdcde; border-radius:6px; padding:20px 24px; min-width:160px; flex:1;">
		<div style="font-size:28px; font-weight:700; color:#1d2327;"><?php echo esc_html( wc_price( $lbite_total_revenue ) ); ?></div>
	...
	<div style="background:#fff; border:1px solid #dcdcde; border-radius:6px; padding:20px 24px; min-width:160px; flex:1;">
		<div style="font-size:28px; font-weight:700; color:#1d2327;"><?php echo esc_html( wc_price( $lbite_avg_order ) ); ?></div>
...
<table class="widefat" style="max-width: 600px;">
	...
	<tbody>
		...
		<tr>
			<td><?php echo esc_html( $lbite_loc_n ); ?></td>
