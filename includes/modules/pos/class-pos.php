		...
		wp_localize_script(
			...
			array(
				...
				'strings'        => array(
					...
					'splitAssigned'         => __( 'Assigned', 'libre-bite' ),
					'splitTotal'            => __( 'Total', 'libre-bite' ),
					'tab'                   => __( 'Tab', 'libre-bite' ),
					'round'                 => __( 'Round', 'libre-bite' ),
					'addItems'              => __( 'Add items', 'libre-bite' ),
					'payClose'              => __( 'Pay / Close', 'libre-bite' ),
					'cancelOrder'           => __( 'Cancel', 'libre-bite' ),
					'closeTab'              => __( 'Close tab', 'libre-bite' ),
					'selectTable'           => __( 'Please select a table', 'libre-bite' ),
					'tabOpened'             => __( 'Tab opened', 'libre-bite' ),
					'itemsAdded'            => __( 'Items added', 'libre-bite' ),
