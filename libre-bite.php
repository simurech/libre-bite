 ...
 * @fs_premium_only /includes/modules/nutritional-info/, /includes/modules/reservations/, /includes/modules/tables/, /templates/checkout-optimized.php, /templates/thankyou-optimized.php, /templates/admin/reservation-board.php, /templates/admin/table-plan.php, /templates/frontend/reservation-form.php, /assets/js/reservation-form.js, /assets/js/checkout-tip.js, /assets/js/checkout-optimized-receipt.js, /assets/js/admin-tables.js, /assets/js/admin-table-plan.js, /assets/js/reservation-board.js, /assets/css/reservation-form.css, /assets/css/checkout-optimized.css, /assets/css/thankyou-optimized.css, /assets/css/admin-tables.css, /assets/css/admin-table-plan.css, /assets/css/admin-reservation-board.css
 */
